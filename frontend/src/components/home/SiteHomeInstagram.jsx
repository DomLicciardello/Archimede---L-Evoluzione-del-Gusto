    ...
    <Container fluid className='home_instagram_style'>
      ...
      <Row>
        ...
        <div className='d-flex flex-column justify-content-center align-items-center ms-5 me-5'>
          ...
          <p style={{fontSize:'20px', textAlign:'center'}}>IN QUESTO MODO PARTECIPERAI OGNI MESE AD UN ESTRAZIONE PER VINCERE UN REGALO!</p>
          ...
          <div className='riga_titolo'><span></span></div>
          <p style={{fontSize:'20px', textAlign:'center'}}>METTI "MI PIACE" ALLA NOSTRA PAGINA FACEBOOK PER RESTARE AGGIORNATO SU TUTTE LE NOVITÀ!</p>
          ...
          <div className='riga_titolo'><span></span></div>
          <p style={{fontSize:'20px', textAlign:'center'}}>PRENOTA ARANCINI E CANNOLI D'ASPORTO CON IL NOSTRO CATALOGO WHATSAPP!</p>
